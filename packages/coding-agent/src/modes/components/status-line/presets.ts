...
export const STATUS_LINE_PRESETS: Record<StatusLinePreset, PresetDef> = {
	...
	minimal: {
		...
		rightSegments: ["plan_mode", "scheduler", "context_pct"],
		separator: "slash",
		segmentOptions: {
	...
	compact: {
		leftSegments: ["model", "plan_mode", "scheduler", "git", "pr"],
	...
	full: {
		leftSegments: ["pi", "hostname", "model", "plan_mode", "scheduler", "path", "git", "pr", "subagents"],
	...
	nerd: {
		...
		leftSegments: ["pi", "hostname", "model", "plan_mode", "scheduler", "path", "git", "pr", "session", "subagents"],
		rightSegments: [
			"token_in",
			"token_out",
			"cache_read",
	...
	ascii: {
		...
		leftSegments: ["model", "plan_mode", "scheduler", "path", "git", "pr"],
