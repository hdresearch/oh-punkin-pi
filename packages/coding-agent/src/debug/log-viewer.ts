import { copyToClipboard, sanitizeText } from "@ohp/natives";
import { type Component, extractPrintableText, matchesKey, padding, truncateToWidth, visibleWidth } from "@ohp/tui";
