...
import { type Skill as CapabilitySkill, skillCapability } from "@ohp/coding-agent/capability/skill";
import { getCapability } from "@ohp/coding-agent/discovery";
import { loadSkills, loadSkillsFromDir, type Skill } from "@ohp/coding-agent/extensibility/skills";
