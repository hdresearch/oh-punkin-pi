...
import type { MarketplacePluginEntry } from "@ohp/coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@ohp/coding-agent/extensibility/plugins/marketplace";
