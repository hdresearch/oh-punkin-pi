...
import { type PendingExtensionRequest, requestRpcEditor } from "@ohp/coding-agent/modes/rpc/rpc-mode";
import type { RpcExtensionUIRequest } from "@ohp/coding-agent/modes/rpc/rpc-types";
