...
import type { Tool, ToolCall } from "@ohp/ai/types";
import { enforceStrictSchema } from "@ohp/ai/utils/schema";
import { validateToolArguments } from "@ohp/ai/utils/validation";
import { Settings } from "@ohp/coding-agent/config/settings";
import type { ToolSession } from "@ohp/coding-agent/tools";
import { SubmitResultTool } from "@ohp/coding-agent/tools/submit-result";
