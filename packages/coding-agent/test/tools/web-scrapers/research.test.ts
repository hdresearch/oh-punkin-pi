...
import { handleBiorxiv } from "@ohp/coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@ohp/coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@ohp/coding-agent/web/scrapers/wikidata";
