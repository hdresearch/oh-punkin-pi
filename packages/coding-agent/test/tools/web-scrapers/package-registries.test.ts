...
import { handleCratesIo } from "@ohp/coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@ohp/coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@ohp/coding-agent/web/scrapers/hex";
import { handleNpm } from "@ohp/coding-agent/web/scrapers/npm";
import { handlePubDev } from "@ohp/coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@ohp/coding-agent/web/scrapers/pypi";
