...
import { handleArxiv } from "@ohp/coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@ohp/coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@ohp/coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@ohp/coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@ohp/coding-agent/web/scrapers/types";
