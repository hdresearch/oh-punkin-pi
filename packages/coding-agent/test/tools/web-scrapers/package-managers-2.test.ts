...
import { handleChocolatey } from "@ohp/coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@ohp/coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@ohp/coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@ohp/coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@ohp/coding-agent/web/scrapers/repology";
import { handleTerraform } from "@ohp/coding-agent/web/scrapers/terraform";
