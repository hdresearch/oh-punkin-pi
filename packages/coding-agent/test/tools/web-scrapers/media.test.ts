...
import { handleHuggingFace } from "@ohp/coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@ohp/coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@ohp/coding-agent/web/scrapers/vimeo";
