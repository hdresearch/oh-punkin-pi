...
import { handleCheatSh } from "@ohp/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@ohp/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@ohp/coding-agent/web/scrapers/tldr";
