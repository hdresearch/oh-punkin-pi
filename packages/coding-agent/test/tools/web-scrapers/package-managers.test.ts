...
import { handleAur } from "@ohp/coding-agent/web/scrapers/aur";
import { handleBrew } from "@ohp/coding-agent/web/scrapers/brew";
import { handleMaven } from "@ohp/coding-agent/web/scrapers/maven";
import { handleNuGet } from "@ohp/coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@ohp/coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@ohp/coding-agent/web/scrapers/rubygems";
