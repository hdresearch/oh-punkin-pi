 ...
 * - ~/.ohp/agent/extensions/ (legacy: ~/.pi/agent/extensions/)
 * - <cwd>/.ohp/extensions/ (legacy: <cwd>/.pi/extensions/)
...
//   1. Place extension files in ~/.ohp/agent/extensions/ or .ohp/extensions/
...
/*
import type { ExtensionAPI } from "@ohp/coding-agent";
