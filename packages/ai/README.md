...
```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from "@ohp/ai";
...
```typescript
import { Type, Tool, StringEnum } from "@ohp/ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@ohp/ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@ohp/ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@ohp/ai";
...
```typescript
import { getModel, stream } from "@ohp/ai";
...
```typescript
import { getProviders, getModels, getModel } from "@ohp/ai";
...
```typescript
import { Model, stream } from "@ohp/ai";
...
```typescript
import { getModel, complete, Context } from "@ohp/ai";
...
```typescript
import { Context, getModel, complete } from "@ohp/ai";
...
```typescript
import { getEnvApiKey } from "@ohp/ai";
...
```bash
bunx @ohp/ai login              # interactive provider selection
bunx @ohp/ai login anthropic    # login to specific provider
bunx @ohp/ai login vllm         # store vLLM API key (or placeholder for local no-auth)
bunx @ohp/ai list               # list available providers
```
...
```typescript
import { loginGitHubCopilot } from "@ohp/ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@ohp/ai";
import * as fs from "node:fs";
