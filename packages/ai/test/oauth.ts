/**
 * Test helper for resolving API keys from ~/.ohp/agent/testauth.db
 *
...
import { getOAuthApiKey } from "@ohp/ai/utils/oauth";
import type { OAuthCredentials, OAuthProvider } from "@ohp/ai/utils/oauth/types";
import { getAgentDir, isEnoent } from "@ohp/utils";
...
/**
 * Resolve API key for a provider from ~/.ohp/agent/testauth.db
 *
