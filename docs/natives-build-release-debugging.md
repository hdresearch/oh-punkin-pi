...
This runbook describes how the `@ohp/natives` build pipeline produces `.node` addons, how compiled distributions load them, and how to debug loader/build failures.
