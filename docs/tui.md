...
## Core component contract (`@ohp/tui`)
...
```ts
import { replaceTabs, truncateToWidth } from "@ohp/tui";
...
import { SelectList, matchesKey, replaceTabs, truncateToWidth } from "@ohp/tui";
import { getSelectListTheme, type ExtensionAPI } from "@ohp/coding-agent";
