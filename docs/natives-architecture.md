...
`@ohp/natives` is a three-layer stack:
...
**Guaranteed contract (API-facing):** consumers import from `@ohp/natives` and use typed wrappers.
...
1. Consumer imports from `@ohp/natives`.
